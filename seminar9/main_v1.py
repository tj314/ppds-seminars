...
The two vectors are randomly generated and then broadcast to all processors.
This solution is not optimal, as the data is broadcasted to all processors,
even though only a part of it is needed.
"""
...
def main():
    ...
    if rank == 0:
        ...
        processor_ranges = np.array([per_processor_range for _ in range(world_size)], dtype=np.int32)
